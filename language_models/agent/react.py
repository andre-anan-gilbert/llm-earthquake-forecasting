...
from language_models.llm.groq import ChatMessage, ChatMessageRole, GroqLanguageModel
...
Observation: tool result will be appended to the conversation
... (this Thought/Tool can repeat N times)
